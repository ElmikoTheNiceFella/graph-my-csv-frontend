...
// Props Types
export type FileUploadProps = { setData: StringArrStateFunction, setError: StringArrStateFunction, setStatus:StringStateFunction, status:string, error:string, token:string }
