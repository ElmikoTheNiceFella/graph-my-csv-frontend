...
const demoData: DataType = [
  [
  {
    ...
    "y-axis": "Company Name",
    "x-axis": "frequency",
    "relationship": "Shows the distribution of phone models across different companies."
  },
  {
    "graph": "histogram",
    "y-axis": "Mobile Weight",
    "x-axis": "Mobile Weight",
    "relationship": "Distribution of mobile phone weights."
  },
  {
    "graph": "bar",
    "y-axis": "RAM",
    "x-axis": "frequency",
    "relationship": "Distribution of RAM sizes."
  },
  {
    "graph": "bar",
    "y-axis": "Front Camera",
    "x-axis": "frequency",
    "relationship": "Distribution of front camera megapixels."
  },
  {
    "graph": "bar",
    "y-axis": "Back Camera",
    "x-axis": "frequency",
    "relationship": "Distribution of back camera megapixels."
  },
  {
    "graph": "bar",
    "y-axis": "Processor",
    "x-axis": "frequency",
    "relationship": "Shows the frequency of different processors used in phones."
  },
  {
    "graph": "histogram",
    "y-axis": "Battery Capacity",
    "x-axis": "Battery Capacity",
    "relationship": "Distribution of battery capacities."
  },
  {
    "graph": "histogram",
    "y-axis": "Screen Size",
    "x-axis": "Screen Size",
    "relationship": "Distribution of screen sizes."
  },
  {
    "graph": "histogram",
    "y-axis": "Launched Price (Pakistan)",
    "x-axis": "Launched Price (Pakistan)",
    "relationship": "Distribution of phone prices in Pakistan."
  },
  {
    "graph": "histogram",
    "y-axis": "Launched Price (India)",
    "x-axis": "Launched Price (India)",
    "relationship": "Distribution of phone prices in India."
  },
  {
    "graph": "histogram",
    "y-axis": "Launched Price (China)",
    "x-axis": "Launched Price (China)",
    "relationship": "Distribution of phone prices in China."
  },
  {
    "graph": "histogram",
    "y-axis": "Launched Price (USA)",
    "x-axis": "Launched Price (USA)",
    "relationship": "Distribution of phone prices in the USA."
  },
  {
    "graph": "histogram",
    "y-axis": "Launched Price (Dubai)",
    "x-axis": "Launched Price (Dubai)",
    "relationship": "Distribution of phone prices in Dubai."
  },
  {
    "graph": "bar",
    "y-axis": "Launched Year",
    "x-axis": "frequency",
    "relationship": "Shows the number of phones launched each year."
  },
  {
    "graph": "scatterplot",
    "y-axis": "Launched Price (USA)",
    "x-axis": "Mobile Weight",
    "relationship": "Shows the relationship between phone weight and price in the USA."
  },
  {
    "graph": "scatterplot",
    "y-axis": "Battery Capacity",
    "x-axis": "Launched Price (India)",
    "relationship": "Shows relationship between battery capacity and launched price in india."
  },
  {
    "graph": "scatterplot",
    "y-axis": "RAM",
    "x-axis": "Launched Price (USA)",
    "relationship": "Shows relationship between RAM and launched price in USA."
  },
  {
    "graph": "scatterplot",
    "y-axis": "Screen Size",
    "x-axis": "Battery Capacity",
    "relationship": "Shows the relationship between screen size and battery capacity."
  }
], 
  ...
  const dataToJson = (data:string) => {
    ...
    for(let i = 0; i < head.length; i++) {
      ...
      for(let j = 1; j < rows.length; j++) {
        result[head[i]][j] = rows[j][i]
      }
    }
    return result
  }

  const data = useMemo(() => dataToJson(demoData[1]), [demoData])
